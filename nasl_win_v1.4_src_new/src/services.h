...
#define NESSUS_SERVICES_TCP	"./services.tcp"
#define NESSUS_SERVICES_UDP	"./services.udp"
/* Not really useful but for debug or information */
#define NESSUS_SERVICES_TXT	"./services.txt"
...
char*	nessus_get_svc_name(struct arglist *, int, const char *, char *);
